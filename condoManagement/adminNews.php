...
<div>
        <form action="./adminNews.php" method="post">
          ...
          <button type="reset" class="buttreset"><a href="./adminNews.php">RESET</a></button>
...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `news` WHERE CONCAT(`no` , `title`) LIKE '%".$valueToSearch."%'";
...
<button class = "buttcreate"><a href = "./adminCreateNews.php">Create</a></button>
