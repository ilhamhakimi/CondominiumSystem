...
<table cellspacing="0" cellpadding="6" class="table">
		  ...
		  <tr bg-color="#337ab7">	
			...
			<th style="color: white; font-family: Trebuchet MS;">RESIDENT ID</th>
			<th style="color: white; font-family: Trebuchet MS;">PASSWORD</th>
            ...
            <th style="color: white; font-family: Trebuchet MS;">BLOCK</th>
            <th style="color: white; font-family: Trebuchet MS;">UNIT</th>
		  </tr>
...
?>
    ...
    <form id="formUpdate" action="adminUpdateResident.php" method="post">
        <input type="hidden" id="emailUpdate" name="emailUpdate">
    </form>
